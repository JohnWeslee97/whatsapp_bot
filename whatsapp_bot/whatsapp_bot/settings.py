...
VERIFY_TOKEN = os.getenv('VERIFY_TOKEN', 'John_weslee_07')
...
SECRET_KEY = 'django-insecure-8br+yglcq0n!64rd_&%)5m(-ko&@cumc_58slm*63ie#ug#wp2'
...
# Media files configuration (knowledge base documents)
MEDIA_URL = '/media/'
MEDIA_ROOT = BASE_DIR / 'knowledge_base'
